...
![alt text](/assets/tutorials/image.png)
- **数据端口 (Data)**: 任何颜色的圆，用于在节点间传递信息（如数字、字符串、坐标）。
![alt text](/assets/tutorials/image-1.png)
